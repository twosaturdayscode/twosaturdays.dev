...
export default function MainLayout({ children }) {
  return (
    <>
      ...
      <div className="container mx-auto flex h-full min-h-screen w-full flex-col justify-between items-stretch bg-[#FFFFFA] px-6 pt-16 text-zinc-800 selection:bg-yellow-400 lg:px-40 xl:px-80">
